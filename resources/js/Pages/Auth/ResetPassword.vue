    ...
    <div class="auth-root">
        <div class="auth-left">
            <div class="auth-left-content">
                ...
                <p class="left-sub">Reset your password to get back to ordering!</p>
                <div class="tips">
                    <p class="tips-title">🔐 Password Tips</p>
                    <div class="tip-item">✅ At least <strong>8 characters</strong></div>
                    <div class="tip-item">✅ Mix of <strong>letters & numbers</strong></div>
                    <div class="tip-item">✅ Avoid <strong>common passwords</strong></div>
                </div>
            </div>
        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrap">
                            ...
                            <input
                                ...
                                :class="['form-input', { 'input-error': form.errors.email }]"
                            />
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrap">
                            ...
                            <input
                                ...
                                autocomplete="new-password"
                                :class="['form-input', { 'input-error': form.errors.password_confirmation }]"
                            />
                        </div>
...
.tips { display: flex; flex-direction: column; gap: 0.6rem; }
.tips-title { font-weight: 700; color: #fff; margin-bottom: 0.25rem; font-size: 0.95rem; }
.tip-item {
...
h2 {
    ...
    color: #064e3b; margin-bottom: 0.25rem;
}
